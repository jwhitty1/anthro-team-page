  ...
  return (
    <div className=" text-xl mx-2 text-base text-th-primary-dark">
      <Popover className="relative">
        ...
        <Popover.Panel className="rounded text-xl z-40 w-48 -translate-x-0  translate-y-3 border absolute z-10 bg-th-background">
  ...
  return (
    <div className=" text-xl mx-2 text-base text-th-primary-dark">
      <Popover className="relative">
        ...
        <Popover.Panel className="rounded  text-xl z-40 border border-ygg-purple-300 w-48 absolute -translate-x-0 translate-y-3 z-40 bg-th-background">
          <div className="flex flex-col ">
            <a
              className="w-full py-4 hover:bg-th-primary-light "
            ...
            <a className="w-full py-4 hover:bg-th-primary-light " href="/team">
              Team
            </a>
            <a
              className="w-full py-4 hover:bg-th-primary-light "
  ...
  function ProfileDropdown() {
    return (
      <Popover className="relative">
        ...
        <Popover.Panel className="rounded z-40 font-futura text-xl text-th-primary-dark border w-48 absolute -translate-x-6 lg:-translate-x-16 translate-y-4 z-10 bg-th-background">
          <div className="flex flex-col">
            <a className="w-full py-4 hover:bg-th-primary-light " href="/">
              Profile
            </a>
